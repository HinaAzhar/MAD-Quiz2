    ...
    try {
      ...
      for (let y = 0; y < scaledHeight; y++) {
        for (let x = 0; x < scaledWidth; x++) {
          ...
          buffer[offset + 1] = data[originalOffset + 1]; //copies the green component of the pixel
          buffer[offset + 2] = data[originalOffset + 2]; //copies the blue component of the pixel
